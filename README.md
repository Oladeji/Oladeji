[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&color=36BCF7&width=600&lines=Hi%2C+I'm+Oladeji+Akomolafe;Software+Engineer+%7C+.NET+%7C+React;Cloud+|+DevOps+|+AI+Enthusiast)](https://git.io/typing-svg)

# 👋 Hello, I’m Oladeji Akomolafe  

**Software Engineer | Full-Stack Developer | Cloud & DevOps Enthusiast**  

I design and build scalable, user-focused software solutions. With expertise in **full-stack development, cloud infrastructure, and DevOps**, I create applications that are efficient, maintainable, and production-ready. Passionate about optimizing workflows and leveraging modern technologies to deliver business value.  
...
Kafka | Optimizely | Tealium | Linux | AI/ML | Deep Learning | Statistical Analysis  
...
A lightweight **CRM platform** for small businesses with AI-powered lead scoring, email drafting, and analytics dashboards.  
**Tech:** .NET 8 Minimal API · React · PostgreSQL · Azure  

### 🔹 [SaaS Task Manager](https://github.com/Oladeji/saas-task-manager)  
A subscription-based **Task & Project Management platform** with AI-driven productivity insights and team collaboration tools.  
**Tech:** .NET 8 · React · Docker · GitHub Actions  
